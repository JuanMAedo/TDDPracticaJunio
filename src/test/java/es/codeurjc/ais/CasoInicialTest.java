...
public class CasoInicialTest {
    ...
    public void casoUnoTest() throws IllegalPositionException{
        ...
        atacantes.add(uno);
        String resultadoEsperado = "Carta uno (5/1/Izquierda/Efectos: N/A) vs Nadie (Vacío) -> Daño directo de 5 punto(s).";
    ...
    public void casoDosTest() throws IllegalPositionException{
        ...
        String resultadoEsperado = "Carta uno (3/2/Izquierda/Efectos: N/A) vs Carta cuatro (8/4/Izquierda/Efectos: N/A)" +
    ...
    public void casoTresTest() throws IllegalPositionException{
        ...
        String resultadoEsperado = "Carta dos (3/2/Centro/Efectos: N/A) vs Carta cinco (8/1/Centro/Efectos: N/A) -> " +
    ...
    public void casoCuatroTest() throws IllegalPositionException{
        ...
        atacantes.add(tres);
        defensores.add(cinco);
        String resultadoEsperado = "Carta tres (6/3/Derecha/Efectos: N/A) vs Nadie (Vacío) -> " +
    ...
    public void casoCincoTest() throws IllegalPositionException{
        ...
        atacantes.add(seis);
        defensores.add(cinco);
        String resultadoEsperado = "Carta dos (3/1/Centro/Efectos: N/A) vs Carta cinco (0/3/Centro/Efectos: N/A) -> " +
                "Carta cinco pierde 3 punto(s) de Vida. Carta cinco destruido/a. " +
                "Carta seis (6/3/Derecha/Efectos: N/A) vs Nadie (Vacío) -> Daño directo de 6 punto(s).";
        assertEquals(resultadoEsperado, Combate.combatir(atacantes, defensores));
    }
    ...
    public void casoSeisTest() throws IllegalPositionException{
        ...
        defensores.add(cinco);
        defensores.add(cuatro);
        String resultadoEsperado = "Carta uno (7/2/Izquierda/Efectos: N/A) vs Carta cuatro (5/3/Izquierda/Efectos: N/A) -> " +
                "Carta cuatro pierde 7 punto(s) de Vida. Carta cuatro destruido/a. " +
                "Carta dos (2/1/Centro/Efectos: N/A) vs Carta cinco (0/1/Centro/Efectos: N/A) -> " +
                "Carta cinco pierde 2 punto(s) de Vida. Carta cinco destruido/a. " +
                "Carta tres (0/4/Derecha/Efectos: N/A) vs Carta seis (4/7/Derecha/Efectos: N/A) -> " +
